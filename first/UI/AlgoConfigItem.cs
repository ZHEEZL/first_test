...
namespace first
{
    ...
    public sealed class AlgoConfigItem
    {
        ...
        {
            new AlgoConfigItem { Name = "f(v) = 1 (константа)", ClassName = "O(1)", DefaultMaxN = 1200, MaxN = 1200, DefaultStep = 50, Step = 50, DefaultRuns = 5, Runs = 5, Factory = () => new ConstantFunction() },
            new AlgoConfigItem { Name = "Сумма элементов", ClassName = "O(n)", DefaultMaxN = 1800, MaxN = 1800, DefaultStep = 50, Step = 50, DefaultRuns = 5, Runs = 5, Factory = () => new SumFunction() },
            new AlgoConfigItem { Name = "Произведение элементов", ClassName = "O(n)", DefaultMaxN = 1700, MaxN = 1700, DefaultStep = 50, Step = 50, DefaultRuns = 5, Runs = 5, Factory = () => new ProductFunction() },
            ...
            new AlgoConfigItem { Name = "Полином (Горнер)", ClassName = "O(n)", DefaultMaxN = 1800, MaxN = 1800, DefaultStep = 50, Step = 50, DefaultRuns = 5, Runs = 5, Factory = () => new PolynomialHorner() },
            ...
            new AlgoConfigItem { Name = "Поразрядная сортировка (Radix sort)", ClassName = "O(n)", DefaultMaxN = 500, MaxN = 500, DefaultStep = 50, Step = 50, DefaultRuns = 5, Runs = 5, Factory = () => new RadixSortAlg() },
            ...
            new AlgoConfigItem { Name = "Степень (рекурсивный RecPow, рис. 2)", ClassName = "O(log n)", DefaultMaxN = 30000, MaxN = 30000, DefaultStep = 50, Step = 50, DefaultRuns = 5, Runs = 5, Factory = () => new PowRecursive() },
            new AlgoConfigItem { Name = "Степень (быстрый QuickPow, рис. 3)", ClassName = "O(log n)", DefaultMaxN = 30000, MaxN = 30000, DefaultStep = 50, Step = 50, DefaultRuns = 5, Runs = 5, Factory = () => new PowQuick() },
            new AlgoConfigItem { Name = "Степень (классический быстрый QuickPow1, рис. 4)", ClassName = "O(log n)", DefaultMaxN = 30000, MaxN = 30000, DefaultStep = 50, Step = 50, DefaultRuns = 5, Runs = 5, Factory = () => new PowQuick1() },
